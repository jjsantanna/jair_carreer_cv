\documentclass[print]{friggeri-cv-linux} % Add 'print' as an option into the square bracket to remove colors from this template for printing
...
%I am interested in a research \& development position with focus on network
%management and the use of big data technologies to improve network data
%analysis and network operations. A position where I can transfer my enthusiasm,
%knowledge, skills and experience into meaningful innovation to improve the
%security in computer networks, specially in the Internet. 
...
\section{Capacity to Stablish Collaboration}
